...
export const createAuction = async (nftID: number, duration: number, yield_: number, minimumLoanValueRequested: number, rollingContract: boolean) => {
    const cadence = CREATE_LOAN_AUCTION('Basket', '0xBasket')
